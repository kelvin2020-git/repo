...
const Pagination = ({pages, setCurrentPage, currentProyecto, sortedProyecto}) => {
    const numOfPages = [];
    ...
    return (
        ...
        <div className="hint-text">Mostrando <b>{currentProyecto.length}</b> de <b>{sortedProyecto.length}</b> Entradas</div>
