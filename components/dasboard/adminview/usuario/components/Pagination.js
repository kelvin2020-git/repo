...
const Pagination = ({pages, setCurrentPage, currentUsuario, sortedUsuarios}) => {
    const numOfPages = [];
    ...
    return (
        ...
        <div className="hint-text">Mostrando<b>{currentUsuario.length}</b> de <b>{sortedUsuarios.length}</b> Entradas</div>
